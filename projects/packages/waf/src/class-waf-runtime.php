...
class Waf_Runtime {
	...
	public function write_blocklog( $rule_id, $reason ) {
		...
		$log_data['user_agent']   = $_SERVER['HTTP_USER_AGENT'] ?? ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
		$log_data['referer']      = $_SERVER['HTTP_REFERER'] ?? ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
		$log_data['content_type'] = $_SERVER['CONTENT_TYPE'] ?? ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
